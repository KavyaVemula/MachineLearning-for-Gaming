"""
This class programs the snake, its movements, updates score and checks if its alive
""" 
...
class snake_segment(pygame.sprite.Sprite):
    ...
    # To add the segment to the snake
...
class Game():
    ...
    def step(self, direction):
        ...
        #Direction of the snake on keyboard
        ...
        #Direction of the Snake in random play
        currentmovedir = self.snake.movedir
        if direction == 2:
            tomove = currentmovedir
        else:
